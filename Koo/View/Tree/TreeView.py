...
class TreeView(AbstractView):
    ...
    def setGridWidth(self, width):
        if self._widgetType == 'list':
            self.widget.setGridSize(
                QSize(width, self.widget.gridSize().height()))

    def setGridHeight(self, height):
        if self._widgetType == 'list':
            self.widget.setGridSize(
                QSize(self.widget.gridSize().width(), height))
    ...
    def addAggregate(self, name, label, bold, digits):
        ...
        self.aggregates.append(
            {'name': name, 'widget': aggValue, 'digits': digits})
    ...
    def finishAggregates(self):
        ...
        self.uiUpdateAggregates = QLabel(
    ...
    def setSelected(self, record):
        ...
        if idx != None:
            self.selecting = True
            self.widget.selectionModel().setCurrentIndex(
    ...
    def display(self, currentRecord, recordGroup):
        ...
        if currentRecord:
            ...
            if idx:
                ...
                self.widget.selectionModel().select(self.widget.currentIndex(
    ...
    def selectAll(self):
        ...
        self.widget.selectionModel().select(
    ...
    def updateAggregates(self):
        ...
        for agg in self.aggregates:
            ...
            if calculate:
                ...
                agg['widget'].setText(
                    Numeric.floatToText(value, agg['digits'], True))
            else:
                agg['widget'].setText('-')
